  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <RefreshCw className="h-8 w-8 animate-spin text-[#2472e0]" />
        <span className="ml-2 text-[#647287]">Loading analytics...</span>
      </div>
    );
  }
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="px-3 py-2 border border-[#dce0e5] rounded-lg focus:ring-2 focus:ring-[#2472e0] focus:border-transparent"
          >
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-[#dce0e5]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#111417]">{formatCurrency(data.overview.totalRevenue)}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-[#dce0e5]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#111417]">{formatNumber(data.overview.totalOrders)}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-[#dce0e5]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#111417]">{formatPercentage(data.overview.conversionRate)}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-[#dce0e5]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#111417]">{formatCurrency(data.overview.averageOrderValue)}</p>
            </div>
